...
Digital Eyes is a marketplace for purchase and sale of Solana NFTs. Listing fees for sale are 0.01 SOL, service fees to the buyer are 2.5% plus any royalty % for the creator.
...
For more advanced users, they may want to deploy their own customizable storefront and create an auction. Additional information on creating a Metaplex storefront can be found on the SolXBlog:
